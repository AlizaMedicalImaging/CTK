...
#ifndef __ctkDICOMCodecUtils_h
#define __ctkDICOMCodecUtils_h

#include "ctkDICOMCoreExport.h"
#include <QByteArray>
#include <QString>

class CTK_DICOM_CORE_EXPORT ctkDICOMCodecUtils
{
public:
   ...
   */
  static QString toUTF8(const QByteArray* ba, const char* charset, bool* ok = nullptr);
